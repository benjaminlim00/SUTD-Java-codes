...
public class CharaDbHelper extends SQLiteOpenHelper {
    ...
    private CharaData getDataFromCursor(int position, Cursor cursor){
        ...
        int nameIndex = cursor.getColumnIndex(CharaContract.CharaEntry.COL_NAME);   //we are retrieving data from the col containing the col name. this gives the name
    ...
    public void insertOneRow(CharaData charaData){
        ...
        writeableDb.insert(CharaContract.CharaEntry.TABLE_NAME, null, contentValues);
    }
    ...
    public int deleteOneRow(String name){
        ...
        Log.i("Logcat", "rows delted: " + rowsDeleted);
        return rowsDeleted;
    }
