...
public class DataEntryActivity extends AppCompatActivity {
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (bitmapSelected == null) {
                        Toast.makeText(DataEntryActivity.this, "no image selected", Toast.LENGTH_LONG).show();
                    } else {
                        ...
                        //here we added the data into the SQL
                        Toast.makeText(DataEntryActivity.this, "inserting to database", Toast.LENGTH_LONG).show();
                    ...
                    e.printStackTrace();
                    Toast.makeText(DataEntryActivity.this, "failed", Toast.LENGTH_LONG).show();
                }
            }
        });
    ...
    //this is for when we finished selecting a photo form the gallery
    @Override
