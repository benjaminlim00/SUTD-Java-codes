...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //test code to add and remove to database
        TestCharaDbHelper.testInsertOneRow(charaDbHelper, "Alan Turing", "WW2 Computer Scientist", R.drawable.alanturing);
        ...
        //TODO run your app and see result in logcat
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_FAB && resultCode == Activity.RESULT_OK) {
            //My choice is to display a Toast that says how many rows our database has
            long numberOfRows = charaDbHelper.queryNumRows();
            Toast.makeText(MainActivity.this, "Number of rows: " + numberOfRows, Toast.LENGTH_LONG).show();
        }
        if (resultCode == Activity.RESULT_CANCELED) {
            //complete however you like
        }
