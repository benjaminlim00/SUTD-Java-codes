package com.example.benjamin.mockfinals3;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //maketext lies in an activity which is an subclass of an context,
        // hence calling this within makeText retrieves the parent activity
        // which is of activity class which extends an Context obj. Hence it
        // is an acceptable input.

        timePicker.setOnTimeChangedListener(
        //onTimeChangedListener is a callback interface that informs the activity when there is a change in the
                //time selected.
